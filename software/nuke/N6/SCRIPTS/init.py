...
nuke.knobDefault("format", "720 576 0 0 720 576 1.067 PAL_1.067")
...
#sys.path.append("//Bigboy/D/tfxtools/Nuke/python")
#sys.path.append("/mnt/tfxtools/Nuke/python")
#sys.path.append("/Volumes/d/tfxtools/Nuke/python")
